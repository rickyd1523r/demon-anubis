# Dont Change This Line. Otherwise It will not work, All credit goes to Kakashi @YeahOffline
...
def reverse(update, context):
    ...
    if reply:
        ...
        msg.reply_markdown(
            "ᴘᴅʜᴀɪ ʟɪᴋʜᴀɪ ᴋʀᴏ ɪᴀs ᴡᴀɪs ʙᴀɴᴏ ᴅᴇsʜ ᴋᴏ sᴀᴍʙʜᴀʟᴏ...😠!\nʏᴀʜᴀ ᴡᴀɪғᴜ ᴘᴀᴋᴀᴅɴᴇ sᴇ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟɴᴇ ᴡᴀʟᴀ😒 #ɴᴏᴡᴀɪғᴜ 🤐👍 "
        )
        return
...
REVERSE_HANDLER = DisableAbleCommandHandler(
    ["harem", "hharem", "top", "htop", "guess", "challenge",  "grab", "protecc"],
    reverse,
    pass_args=True,
    run_async=True,
)
